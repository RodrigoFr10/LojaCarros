...
namespace LojaCarros.Controllers
{
    public class CarroesController : Controller
    {
        ...
        public CarroesController(LojaCarrosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Carro != null ? 
                          ...
                          Problem("Entity set 'LojaCarrosContext.Carro'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LojaCarrosContext.Carro'  is null.");
            }
            var carro = await _context.Carro.FindAsync(id);
            if (carro != null)
            {
