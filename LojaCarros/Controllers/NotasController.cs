...
namespace LojaCarros.Controllers
{
    ...
    {
        private readonly LojaCarrosContext _context;

        public NotasController(LojaCarrosContext context)
        {
            _context = context;
        }
        ...
        {
            var lojaCarrosContext = _context.Nota.Include(n => n.Carro).Include(n => n.Comprador).Include(n => n.Vendedor);
            return View(await lojaCarrosContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LojaCarrosContext.Nota'  is null.");
            }
            var nota = await _context.Nota.FindAsync(id);
            if (nota != null)
            {
